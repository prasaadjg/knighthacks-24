  ...
  // user friends
    ...
    export const friends = createTable(
      "friends",
      {
        //TODOreferences removes needing a foreign key
      ...
      export type InsertFriends = typeof friends.$inferInsert;
      export type SelectFriends = typeof friends.$inferSelect;
  ...
  export const groups = createTable(
    ...
    export type InsertGroups = typeof groups.$inferInsert;
    export type SelectGroups = typeof groups.$inferSelect;
  ...
  export type InsertMembers = typeof members.$inferInsert;
  export type SelectUsers = typeof members.$inferSelect;
  ...
  export const meetings = createTable(
    ...
    export type InsertMeetings = typeof meetings.$inferInsert;
    export type SelectMeetigs = typeof meetings.$inferSelect;
  //for availibiities 
  export const availabilities = createTable(
    ...
    export type InsertAvailabilities = typeof availabilities.$inferInsert;
    export type SelectAvailabilities = typeof availabilities.$inferSelect;